      ...
      {file ? (
        <div className="dropzone__preview">
          ...
          <div className="dropzone__meta">
            ...
            <span className="dropzone__filesize">{(file.size / 1024).toFixed(1)} KB — click to change</span>
          </div>
        </div>
      ) : (
        <div className="dropzone__empty">
          ...
          <p className="dropzone__subtitle">or <span style={{ color: accent }}>click to browse</span></p>
